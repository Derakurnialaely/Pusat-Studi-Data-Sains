...
![](E:/Kelas Mahir/KM001/KM01 Header Notebook.png)
...
```{r}
df  <- read.csv("https://raw.githubusercontent.com/Derakurnialaely/Pusat-Studi-Data-Sains/main/titanic_modify.csv",sep=';', stringsAsFactors = T)
df[0:5,]
```
...
names(df)
```
Menunjukan bahwa memiliki data dengan variabel nama Passengerid, Survived dan lain-lain.
```{r}
str(df)
```
